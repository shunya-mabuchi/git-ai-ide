...
- Local Preview の WebContainer preflight を確認する
- PR 作成前 Safety Gate で Diff / Tests / Local Preview / Commit / Push / PR draft を確認する
- GitHub Integration の PR flow readiness を確認する
- demo mode で branch push / PR creation flow を確認する
...
5. Cloudflare Pages / Workers / D1 に寄せ、無料公開と backend 設計の説明を両立した
